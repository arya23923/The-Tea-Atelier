    ...
    return(
        <div className={`${montserrat.className} flex`}>
            ...
            <div className="flex flex-col justify-between items-center w-full h-100 mt-30 md:mt-60 md:h-140">
                ...
                <input type="text" placeholder="Enter email address" className="border border-gray-400 pt-3 pb-3 pr-5 pl-5 rounded-sm bg-gray-400 md:w-100 md:mt-10 text-white"></input>
