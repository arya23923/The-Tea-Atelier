...
const Home : FC = () => {
    return(
        <div className={`bg-[url(/images/home-page.jpg)] bg-cover md:bg-cover w-screen h-screen ${inriaSerif.className}`}>
            ...
            <button className="relative z-10 flex justify-center bg-[#5A4D5D] text-white pt-3 pr-5 pl-5 pb-3 ml-5 rounded-lg cursor-pointer md:ml-25 md:text-xl md:mt-5">EXPLORE</button>
        </div>
    )
}
