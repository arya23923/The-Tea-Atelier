...
const signPage : FC = () => {
    return(
        <div className={`${montserrat.className} flex`}>
            ...
            <div className="flex flex-col justify-between items-center w-full h-100 mt-30 md:mt-60 md:h-150">
                ...
                <input type="text" placeholder="Enter email address" required className="border border-gray-400 pt-3 pb-3 pr-5 pl-5 rounded-sm bg-gray-300 md:w-100 text-black"></input>
                ...
                <button className="flex w-60 justify-center p-5 space-x-3 border border-gray-500 pt-3 pb-3 pr-5 pl-5 rounded-sm mt-10 md:mt-0">
